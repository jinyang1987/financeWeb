...
public class CodeSerialController {
  ...
  @PostMapping("/next")
  public NextResponse next(@Validated @RequestBody NextRequest req) {
  ...
  @GetMapping("/peek")
  public NextResponse peek(String scope, String fondsCode, String typeCode, Integer year, String boxNo) {
