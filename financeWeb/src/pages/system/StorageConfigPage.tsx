                ...
                <div className="p-2 space-y-2 bg-slate-50 rounded-lg">
                  <div className="grid grid-cols-3 gap-2">
                    <label className="block">
                      <span className="text-xs text-slate-500">库房号</span>
                    ...
                    <label className="block col-span-2">
                      <span className="text-xs text-slate-500">库房名称</span>
                  ...
                  <div className="flex gap-1.5">
                    <button type="button" onClick={() => void handleCreateRoom()} disabled={busy === 'add-room'}
                      className="flex-1 flex items-center justify-center gap-1 px-2 py-1.5 text-xs font-semibold text-white bg-sky-600 rounded-lg hover:bg-sky-700 disabled:opacity-50">
                    ...
                    <button type="button" onClick={() => setShowAddRoom(false)}
                      className="px-2 py-1.5 text-xs text-slate-500 bg-white border border-slate-200 rounded-lg hover:bg-slate-100">
                      <X className="w-3 h-3" />
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-5">
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-lg border transition-colors disabled:opacity-40 ${
                      ...
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        {dirty && (
                          <button type="button" onClick={() => void handleSaveRack(r)} disabled={busy === r.id}
                            className="flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-white bg-sky-600 rounded-lg hover:bg-sky-700 disabled:opacity-50">
