  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-50">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-slate-900 via-slate-800 to-sky-900 items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute top-20 left-20 w-64 h-64 bg-sky-500/10 rounded-full whitespace-nowrap blur-3xl" />
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-sky-500/10 rounded-full whitespace-nowrap blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-white/[0.02] rounded-full whitespace-nowrap" />
